jQuery(document).ready(function(){	
	...
	jQuery('.socialRight.socialCenterOuterFb').find('.socialForm').hover(
		function(){
	...
	jQuery('.socialLeft.socialCenterOuterFb').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.socialCenterOuterFb').stop(true,false).animate({
				left: -3
	...
	jQuery('.socialRight.socialCenterOuterTw').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
	...
	jQuery('.socialLeft.socialCenterOuterTw').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.socialCenterOuterTw').stop(true,false).animate({
				left: -3
	...
	jQuery('.socialRight.socialCenterOuterGp').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
	...
	jQuery('.socialLeft.socialCenterOuterGp').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.socialCenterOuterGp').stop(true,false).animate({
				left: -3
	...
	jQuery('.socialRight.socialCenterOuterYt').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
	...
	jQuery('.socialLeft.socialCenterOuterYt').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.socialCenterOuterYt').stop(true,false).animate({
				left: -3
	...
	jQuery('.socialRight.socialCenterOuterVi').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
	...
	jQuery('.socialLeft.socialCenterOuterVi').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.socialCenterOuterVi').stop(true,false).animate({
				left: -3
	...
	jQuery('.socialRight.socialCenterOuterLi').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
	...
	jQuery('.socialLeft.socialCenterOuterLi').find('.socialForm').hover(
		function(){
			jQuery(this).parents('.socialCenterOuter').css('z-index',9999999);
			jQuery(this).parents('.socialCenterOuterLi').stop(true,false).animate({
				left: -3
